...
import { supprimerProduitAvecStock } from "@/lib/Produit";

const ProduitInfo = (props: { setComponet: (component: string) => void }) => {
            ...
            <CardHeader>
              <CardTitle className="flex justify-between items-center ">
                ...
                <div className="flex gap-5">
                  <Button
                    size="sm"
                    onClick={() => props.setComponet("ajustement")}
                  >
                    Ajuster le Stock
                  </Button>
                  <Button
                    size="sm"
                    onClick={() => {
                      if (SelectedProduct?.produit_id) {
                        supprimerProduitAvecStock(SelectedProduct?.produit_id);
                        fetchProducts(15);
                        onClose();
                      }
                    }}
        ...
        <div className="w-[30%] mt-5 px-4 flex flex-col gap-3">
          ...
          <Card className="bg-[#fbfbfb]">
            ...
            <CardContent className="flex flex-col gap-5">
              ...
              <div className="flex gap-2">
                <p className="w-[50%] text-left">Stock Disponible a la vente</p>
                <span className="ml-5">
